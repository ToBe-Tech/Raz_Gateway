...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_MCUBOOT, 0x12000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_SERIAL_DETECT_PIN, 13);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_THINGY91_NRF52840, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_SIZE, 0x12000);
