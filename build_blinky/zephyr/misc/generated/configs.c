...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATTP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATTP_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_GATTP_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_CLOUD_FOTA_LOG_LEVEL_INF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DOWNLOAD_CLIENT_STACK_SIZE, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AT_MONITOR_HEAP_SIZE, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_AUTO_INIT_AND_CONNECT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_1_GPIO_MANAGEMENT, 1);
